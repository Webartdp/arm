    ...
    <div class="row align-center">
        <div class="column small-14 large-12" id="main_cont">
            <div class="response-card dynamic-view bg-white radius-12 shadow-primary">
                <div class="row align-center"><div class="column small-14 large-10">
                    <div class="info-bar result-pin bg-grey-5 radius-8">
                        <div class="flex-container align-middle align-justify">
                            <div class="text-medium helvetica-95 font-spacing-1 color-grey">{{ str_replace('-', ' - ', $tnum) }}</div>
                            <a href="{{ route('front.home', ['locale' => $locale]) }}" class="flex-container align-middle text-xsmall helvetica-55 color-grey-40">
                                <span>{{ $d['search_another'] }}</span><i class="icon icon-close medium suffix"></i>
                            </a>
                        </div>
                    </div>
                    <div class="result-card result-card-danger relative radius-12 bg-danger color-white">
                        <div class="result-card--img"><i class="icon icon-close medium"></i></div>
                        <div class="result-card-danger--title text-large helvetica-75 font-bold color-white">{{ $d['not_found'] }}</div>
                    </div>
                </div></div>
            </div>
        </div>
